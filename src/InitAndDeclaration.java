...
public class InitAndDeclaration {
	...
	public float initFloat( ) {
		...
		p_flt = 12.121f;
		System.out.println("flt = 12.12121212121f; This is declared value for float: " + p_flt);
		System.out.println("-----------------------------------------------------");
		return p_flt;
	}
	public double initDouble( ) {
		...
		System.out.println("dble = 12.121_212_121_212_121_212_121; This is declared value for double: " + p_dbl);
		System.out.println("-----------------------------------------------------");
		return p_dbl;
	}
